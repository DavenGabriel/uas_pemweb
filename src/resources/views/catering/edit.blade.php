...
<form action='{{url('catering/'.$data->nama_paket)}}' method='post'>
@csrf
@method('PUT')
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name='customer' value="{{$data->customer}}" id="customer">
            </div>
        </div>
        <div class="mb-3 row">
            <label for="nomorHP" class="col-sm-2 col-form-label">Nomor HP</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name='nomorHP' value="{{$data->nomorHP}}" id="nomorHP">
            </div>
        </div>
        <div class="mb-3 row">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name='pembayaran' value="{{$data->pembayaran}}" id="pembayaran">
            </div>
        </div>
        <div class="mb-3 row">
